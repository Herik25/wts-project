...
import {
  ...
  fetchAllWomensJoggersAsync,
  fetchWomenJoggersByFiltersAsync,
  selectAllProducts,
...
function WomenJoggers() {
  ...
  useEffect(() => {
    dispatch(fetchAllWomensJoggersAsync());
  }, [dispatch]);

  useEffect(() => {
    dispatch(fetchWomenJoggersByFiltersAsync(filter));
  }, [filter, dispatch]);
