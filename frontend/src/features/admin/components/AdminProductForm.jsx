...
import { uploadProductAsync } from "../../products/ProductSlice";
...
function AdminProductForm() {
  ...
  const handleBestSellerChange = () => {
    setIsBestSeller((prevValue) => !prevValue);
  };
      ...
      <div className=" flex justify-between items-center h-16 bg-white border-b-[2px] border-b-[#f0f0f0] ">
        <div className=" flex items-center ml-14">
          ...
          <div className=" flex flex-col ml-4">
            ...
            <span className=" font-bold mt-[2px] font-base">
              Add New Product
            </span>
          </div>
        </div>
            ...
            <div className=" mt-2 overflow-y-auto flex h-20 w-full no-scrollbar rounded-md">
              {images &&
                images.map((image, index) => {
                  return(
                    <img key={index} className=" mr-1" src={image} alt="product" />
                  )
                })
              }
            </div>
